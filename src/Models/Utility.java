...
import static Config.ConfigLoader.cols;
import static Config.ConfigLoader.rows;
...
//    };
    ...
    public static Region getRandomRegion(Territory territory){
        return territory.getRegion(getRandomNumber(ConfigLoader.getRows()), getRandomNumber(ConfigLoader.getCols()));
    }
}
